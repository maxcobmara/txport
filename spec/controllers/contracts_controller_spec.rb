...
describe ContractsController do
  ...
  let(:valid_attributes) { { "contract_no" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contract as @contract" do
        ...
        post :create, {:contract => { "contract_no" => "invalid value" }}, valid_session
        assigns(:contract).should be_a_new(Contract)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contract" do
        ...
        Contract.any_instance.should_receive(:update).with({ "contract_no" => "MyString" })
        put :update, {:id => contract.to_param, :contract => { "contract_no" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contract as @contract" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contract.any_instance.stub(:save).and_return(false)
        put :update, {:id => contract.to_param, :contract => { "contract_no" => "invalid value" }}, valid_session
        assigns(:contract).should eq(contract)
      end
