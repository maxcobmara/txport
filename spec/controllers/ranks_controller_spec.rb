  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved rank as @rank" do
        ...
        post :create, {:rank => { "shortname" => "invalid value" }}, valid_session
        assigns(:rank).should be_a_new(Rank)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested rank" do
        ...
        Rank.any_instance.should_receive(:update).with({ "shortname" => "MyString" })
        put :update, {:id => rank.to_param, :rank => { "shortname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the rank as @rank" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Rank.any_instance.stub(:save).and_return(false)
        put :update, {:id => rank.to_param, :rank => { "shortname" => "invalid value" }}, valid_session
        assigns(:rank).should eq(rank)
      end
