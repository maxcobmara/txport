  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contract_type as @contract_type" do
        ...
        post :create, {:contract_type => { "short_name" => "invalid value" }}, valid_session
        assigns(:contract_type).should be_a_new(ContractType)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contract_type" do
        ...
        ContractType.any_instance.should_receive(:update).with({ "short_name" => "MyString" })
        put :update, {:id => contract_type.to_param, :contract_type => { "short_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contract_type as @contract_type" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ContractType.any_instance.stub(:save).and_return(false)
        put :update, {:id => contract_type.to_param, :contract_type => { "short_name" => "invalid value" }}, valid_session
        assigns(:contract_type).should eq(contract_type)
      end
