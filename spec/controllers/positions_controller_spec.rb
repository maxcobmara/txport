  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved position as @position" do
        ...
        post :create, {:position => { "name" => "invalid value" }}, valid_session
        assigns(:position).should be_a_new(Position)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested position" do
        ...
        Position.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => position.to_param, :position => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the position as @position" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Position.any_instance.stub(:save).and_return(false)
        put :update, {:id => position.to_param, :position => { "name" => "invalid value" }}, valid_session
        assigns(:position).should eq(position)
      end
