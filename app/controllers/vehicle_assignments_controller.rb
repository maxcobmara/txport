class VehicleAssignmentsController < ApplicationController
  ...
  private
    ...
    def vehicle_assignment_params
      params.require(:vehicle_assignment).permit(:document_code, :document_date, :authorised_by, :unit_id,:authoriser_staff_details, vehicle_assignment_details_attributes: [:id, :vehicle_id, :staff_id, :assigned_on, :assignment_end, :release_no, :release_type, :remark])
    end
end
